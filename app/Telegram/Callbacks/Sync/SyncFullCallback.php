...
/**
 * Sync Full Callback Handler
 *
 * Initiates full synchronization conversation with FatSecret.
 * Starts a conversation to select sync date for all data types.
 * Callback name: 'syncFull'
 */
class SyncFullCallback implements CallbackHandler
{
    /**
     ...
     *
     * Starts a sync conversation for full synchronization.
     *
