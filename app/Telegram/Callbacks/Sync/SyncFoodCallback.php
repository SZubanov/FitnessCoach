...
/**
 * Sync Food Callback Handler
 *
 * Initiates food diary synchronization conversation with FatSecret.
 * Starts a conversation to select sync date for food diary data only.
 * Callback name: 'syncFood'
 */
class SyncFoodCallback implements CallbackHandler
{
    /**
     ...
     *
     * Starts a sync conversation for food diary synchronization.
     *
