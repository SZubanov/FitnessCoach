...
/**
 * Select Macro Fats Callback Handler
 *
 * Initiates fats tracking conversation.
 * Requires account linking middleware.
 * Starts conversation to collect date and fats value.
 * Callback name: 'selectMacroFats'
 */
class SelectMacroFatsCallback implements CallbackHandler
{
    /**
