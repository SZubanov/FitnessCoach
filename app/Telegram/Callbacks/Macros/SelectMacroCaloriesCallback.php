...
/**
 * Select Macro Calories Callback Handler
 *
 * Initiates calories tracking conversation.
 * Requires account linking middleware.
 * Starts conversation to collect date and calories value.
 * Callback name: 'selectMacroCalories'
 */
class SelectMacroCaloriesCallback implements CallbackHandler
{
    /**
