...
/**
 * Select Macro Proteins Callback Handler
 *
 * Initiates proteins tracking conversation.
 * Requires account linking middleware.
 * Starts conversation to collect date and proteins value.
 * Callback name: 'selectMacroProteins'
 */
class SelectMacroProteinsCallback implements CallbackHandler
{
    /**
